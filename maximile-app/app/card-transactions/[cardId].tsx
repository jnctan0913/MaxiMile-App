...
// ---------------------------------------------------------------------------
// Per-category icon gradients (same as transactions.tsx)
// ---------------------------------------------------------------------------
...
export default function CardTransactionsScreen() {
  ...
  const displayName = cardName ? decodeURIComponent(cardName) : 'Card Transactions';
  ...
  const handleDeleteConfirm = useCallback(
    (item: TransactionRow) => {
      ...
      if (Platform.OS === 'web') {
        if (window.confirm(`Delete Transaction?\n\nThis will adjust your cap tracking for ${cardLabel}.`)) {
          doDelete();
        }
      } else {
        Alert.alert(
          ...
          {sections.length === 0 ? (
            <View style={styles.emptyContainer}>
              ...
              <EmptyState
                ...
                description="Transactions logged for this card will appear here."
              />
            </View>
          ) : (
            <SectionList
