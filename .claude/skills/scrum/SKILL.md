...
name: scrum
description: >
  Agile Scrum Master - transforms PRDs into actionable sprint plans with
  epics, stories, tasks, DoR/DoD, estimation, and dependency maps.
user-invocable: true
argument-hint: "PRD path or project name for sprint planning"
---
...
!`cat docs/PRD.md 2>/dev/null | head -50 || echo "No PRD found. Need docs/PRD.md to begin sprint planning."`

## PM Handover

!`cat .claude/handover/pm-to-scrum.md 2>/dev/null || echo "No PM handover file found."`
...
4. **Estimate** complexity (T-shirt sizing: XS/S/M/L/XL)
...
- [ ] Story is small enough to complete in sprint (max L size)
